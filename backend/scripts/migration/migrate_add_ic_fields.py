"""
数据库迁移脚本：为 candidates 表添加IC相关字段
迁移版本: v3 -> v4
"""
...
def migrate():
    ...
    with engine.connect() as conn:
        ...
        # 需要添加的IC相关字段
        new_fields = {
            "ic_mean_4h": "NUMERIC(10, 6)",
            "ic_mean_24h": "NUMERIC(10, 6)",
            "ic_mean_168h": "NUMERIC(10, 6)",
            "ic_std": "NUMERIC(10, 6)",
            "ic_ir": "NUMERIC(10, 6)",
            "ic_half_life": "NUMERIC(10, 6)",
            "factor_category": "VARCHAR(50)",
            "is_selected_strategy": "BOOLEAN DEFAULT FALSE",
