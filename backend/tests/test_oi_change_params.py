...
# 测试2: window为浮点数
print("\n测试2: window为浮点数 (window=1.006)")
node2 = GPNode(
    node_type='func',
    name='oi_change',
    children=[
        GPNode(node_type='var', name='open_interest'),
        GPNode(node_type='const', name='const', value=1.006),
    ]
)
...
# 测试3: window为负浮点数
print("\n测试3: window为负浮点数 (window=-5.4299)")
node3 = GPNode(
    node_type='func',
    name='oi_change',
    children=[
        GPNode(node_type='var', name='open_interest'),
        GPNode(node_type='const', name='const', value=-5.4299),
    ]
)
